...
//Registration:- 2147207
//Program:- Online Exam system

//importing java librarires:-
import javax.swing.*;
import java.awt.*;
...
class MyFrame extends JFrame implements ActionListener{
    ...
    //constructor to initialize the component with default values:-->
    public MyFrame(){
    ...
    //method actionperformed() to get the action perfomed by user and act accordingly
    ...
    public void actionPerformed(ActionEvent e){
        if(e.getSource()==submit){
            if(term.isSelected()){
                ...
                tout.setEditable(false);
                res.setText("Congratulations you have registered successfully");

            }
            else{
                tout.setText(" ");
                resadd.setText(" ");
                res.setText("\nPlease accept the terms and conditions to proceed futher.");
            }}
